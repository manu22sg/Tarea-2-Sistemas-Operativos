...
int main(int argc, char *argv[])
{
    ...
    {
        std::cerr << "Uso correcto: " << argv[0] << " <imagen_entrada> <imagen_salida> <num_hebras>" << std::endl; //  Muestra los argumentos necesarios para la ejecucion correcta del programa
        return 1;
    }
